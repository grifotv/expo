...
Expo CLI uses a deep link to launch your project, and it's also useful if you plan to [use `expo-dev-client` for launching preview updates](/eas-update/getting-started/), especially if you have added a custom deep link scheme to your project.
